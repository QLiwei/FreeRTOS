...
{
	if ((GPIO_ISTAT(GPIO_PORT_K1) & GPIO_PIN_K1) == 0 && (GPIO_ISTAT(GPIO_PORT_K2) & GPIO_PIN_K2) != 0
		&& (GPIO_ISTAT(GPIO_PORT_K3) & GPIO_PIN_K3) != 0)
		return 1;
	else
		return 0;
}
...
static uint8_t IsKeyDown4(void)	/* K1 K2组合键 */
{
	if ((GPIO_ISTAT(GPIO_PORT_K1) & GPIO_PIN_K1) == 0 && (GPIO_ISTAT(GPIO_PORT_K2) & GPIO_PIN_K2) == 0
		&& (GPIO_ISTAT(GPIO_PORT_K3) & GPIO_PIN_K3) != 0)
		return 1;
...
static void bsp_InitKeyHard(void)
{
	...
	gpio_init(GPIO_PORT_K1, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, GPIO_PIN_K1);
    gpio_init(GPIO_PORT_K2, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, GPIO_PIN_K2);
    gpio_init(GPIO_PORT_K3, GPIO_MODE_IPU, GPIO_OSPEED_10MHZ, GPIO_PIN_K3);
}
